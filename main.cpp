...
//patch to fix to_string in G++ as it is broken in 4.7.1
namespace patch
{
...
public:
	...
	sf::Vector2f CheckInput1(bool& vChanged)
	{
		if (!gameOver)
		{
			if (sf::Keyboard::isKeyPressed(sf::Keyboard::W) && velocity != sf::Vector2f(0, -referenceVelocity) && velocity != sf::Vector2f(0, referenceVelocity))
			{
				velocity = sf::Vector2f(0, -referenceVelocity);
				vChanged = true;
			}
			else if (sf::Keyboard::isKeyPressed(sf::Keyboard::S) && velocity != sf::Vector2f(0, -referenceVelocity) && velocity != sf::Vector2f(0, referenceVelocity))
			{
				velocity = sf::Vector2f(0, referenceVelocity);
				vChanged = true;
			}
			else if (sf::Keyboard::isKeyPressed(sf::Keyboard::A) && velocity != sf::Vector2f(-referenceVelocity, 0) && velocity != sf::Vector2f(referenceVelocity, 0))
			{
				velocity = sf::Vector2f(-referenceVelocity, 0);
				vChanged = true;
			}
			else if (sf::Keyboard::isKeyPressed(sf::Keyboard::D) && velocity != sf::Vector2f(-referenceVelocity, 0) && velocity != sf::Vector2f(referenceVelocity, 0))
			{
				velocity = sf::Vector2f(referenceVelocity, 0);
				vChanged = true;
			}
	...
	sf::Vector2f CheckInput2(bool& vChanged)
	{
		if (!gameOver)
		{
			if (sf::Keyboard::isKeyPressed(sf::Keyboard::Up) && velocity != sf::Vector2f(0, -referenceVelocity) && velocity != sf::Vector2f(0, referenceVelocity))
			{
				velocity = sf::Vector2f(0, -referenceVelocity);
				vChanged = true;
			}
			else if (sf::Keyboard::isKeyPressed(sf::Keyboard::Down) && velocity != sf::Vector2f(0, -referenceVelocity) && velocity != sf::Vector2f(0, referenceVelocity))
			{
				velocity = sf::Vector2f(0, referenceVelocity);
				vChanged = true;
			}
			else if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left) && velocity != sf::Vector2f(-referenceVelocity, 0) && velocity != sf::Vector2f(referenceVelocity, 0))
			{
				velocity = sf::Vector2f(-referenceVelocity, 0);
				vChanged = true;
			}
			else if (sf::Keyboard::isKeyPressed(sf::Keyboard::Right) && velocity != sf::Vector2f(-referenceVelocity, 0) && velocity != sf::Vector2f(referenceVelocity, 0))
			{
				velocity = sf::Vector2f(referenceVelocity, 0);
				vChanged = true;
			}
...
{
	player1Text.setString("Player1 Score: " + patch::to_string(player1Score));
	player2Text.setString("Player2 Score: " + patch::to_string(player2Score));
...
int main()
{
	...
	while (window.isOpen())
	{
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Escape)) window.close(); //Close Window and Exit Loop
		...
		if (gameOver && sf::Keyboard::isKeyPressed(sf::Keyboard::Return)) //Reset the Game
		{
			reset(player1, player2);
		}
